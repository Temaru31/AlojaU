...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  telegram_chat_id VARCHAR(32)  -- M5 DM OTP $0 (NULL = sin vincular; nunca canales/grupos)
);
...
-- 5b. Tipos de vivienda dinámicos (mig 013). El catálogo vive en BD, no en CHECK.
...
-- M2: tipo_inmueble es FK RESTRICT a housing_types (sin CHECK estático).
CREATE TABLE IF NOT EXISTS publicaciones (
  ...
  tipo_inmueble VARCHAR(40) NOT NULL REFERENCES housing_types(slug) ON DELETE RESTRICT ON UPDATE CASCADE,
